...
model.pieces[ 2].position = { cell: model.cells[ 2], face: 0, player: 1, isOut: false, isExcluded: false };
model.pieces[ 3].position = { cell: model.cells[33], face: 0, player: 0, isOut: false, isExcluded: false };
model.pieces[ 4].position = { cell: model.cells[ 1], face: 0, player: 1, isOut: false, isExcluded: false };
model.pieces[ 5].position = { cell: model.cells[34], face: 0, player: 0, isOut: false, isExcluded: false };
model.pieces[ 6].position = { cell: model.cells[ 4], face: 0, player: 1, isOut: false, isExcluded: false };
model.pieces[ 7].position = { cell: model.cells[31], face: 0, player: 0, isOut: false, isExcluded: false };
